                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="javascript:consultaHistoria('.$idusuario.','.$idcita.','.$areaFon.','.$idTerapeuta.')" class="btn btn-sm dropdown-item" >
                                                <i class="fa fa-edit"></i> Historia Cl&iacute;nica
                                            </a>
                                            <a href="fonoaudiologia_prueba.php?var='.$idusuario.'&cita='.$idcita.'&idarea='.$areaFon.'" class="btn btn-sm dropdown-item" >                                         
